<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmApprovalFinanceAuthority.aspx.vb" Inherits="frmApprovalFinanceAuthority" Theme="Blue" %>
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
                        ...
                        <div id="Div1" style ="text-align:center ; background-color:#3a4f63; font-size :14px; height :25px; border-radius :25px 25px 0px 0px;">
                         ...
                         <%--<div style ="text-align :left  ; padding : 5px;" >
                              <div style ="float :left; width :40%">
                                   <asp:RadioButton ID="rdCurrentApproval" Text ="Current Approval" runat="server" /></div>
                              <div style ="width :40%; text-align :right ;">
                                   <asp:RadioButton ID="rdPastApproval" Text ="Past Approval" runat="server" /></div>
                              </div>
                         </div>--%>
                        <div style ="text-align :left  ; padding : 0px;"> 
                             
                             <asp:RadioButton ID="rdCurrentApproval" Text ="Current Approval" runat="server" Checked ="true" GroupName ="ApprovalGroup" AutoPostBack="True"  />
                             <asp:RadioButton ID="rdHistorical" Text ="Historical Approval" runat="server" GroupName ="ApprovalGroup" AutoPostBack="True" />
        ...
        <div><hr /></div>
             ...
             <div id="dvTag" style ="width :100%; padding : 5px; text-align :right ; margin-bottom :50px; ">
                  ...
                  <div id="dvAuthorised" style="float:left; padding-left: 20px;" runat="server"><asp:Button ID="btnAuthorised" runat="server" Text="Authorised" /></div>

                   <div id="dvCancelCheck" style="float:left; padding-left: 20px;" runat="server"><asp:Button ID="btnCancelAuthorized" runat="server" Text="Cancel Confirmation" /></div>
