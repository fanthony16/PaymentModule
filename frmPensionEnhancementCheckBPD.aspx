<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmPensionEnhancementCheckBPD.aspx.vb" Inherits="frmPensionEnhancementCheckBPD" Theme ="Blue"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>Pension Enhancement Verification (BPD)...</span></h2></div>
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ; height :1020px;">
               ...
               <div id="dvSideBox" style="float:left; width:320px; height :300px;  padding :8px;" >
                    ...
                    <div style=" width :100%; padding : 0px; border-color:#3a4f63; border :2px solid ; margin-bottom :20px; border-radius :25px 25px 0px 0px;">
                        ...
                        <div id="dvStateDate" class ="dvBoxRows">
                                ...
                                <div style="text-align :right ;"><asp:TextBox ID="txtRunDate" runat="server" Width ="200px" ValidationGroup="FindPIN"></asp:TextBox>

                                       <asp:RequiredFieldValidator ID="reqRunDate" runat="server" ErrorMessage="*" ControlToValidate="txtRunDate" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="FindPIN"></asp:RequiredFieldValidator>
                                ...
                                <asp:Panel ID="pnlRunDate" runat="server">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                        <asp:Calendar ID="calRunDate" runat="server" BackColor="White" 
            ...
            <asp:Panel ID="Panel1" runat ="server" Visible="False"><div style ="padding:5PX;"><span id="Span1" runat ="server" >.</span></div></asp:Panel>
                             ...
                             <div style ="padding-right :10px;"> <asp:Button ID="btnFind" runat="server" Text="Find" ValidationGroup="FindPIN" /></div>
                    ...
                    <asp:Panel ID="pnlGrid" Width ="100%" runat ="server" Height ="870px"  >
                                 ...
                                 <Columns >
                                        ...
                                        <asp:TemplateField HeaderText="Checked?">
                                             <ItemTemplate>
                                                  <asp:CheckBox ID="ChkPINReviewChecked" runat="server" Enabled="true"  AutoPostBack="true"/>
                                             </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <div><hr /></div>
             ...
             <div id="dvTag" style ="width :100%; padding : 5px; text-align :right ; margin-bottom :50px; ">
                 ...
                 <div id="dvReject" style="float:left; padding-left: 20px;" runat="server"><asp:Button ID="btnReject" style="color:white; background-color:red;" runat="server" Text="Reject Approval Confirmation" Visible ="false"  /></div>


                  <div id="dvChecked" style="float:left; padding-left: 20px;" runat="server"><asp:Button ID="btnChecked" style="color:white; background-color:green;" runat="server" Text="BPD Checked" /></div>
