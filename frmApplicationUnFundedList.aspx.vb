...
Partial Class frmApplicationUnFundedList
		...
		Try
			...
			ElseIf IsPostBack = False And Context.Request.QueryString("ApplicationID") Is Nothing Then
				...
				ElseIf IsNothing(Session("user")) = False And IsNothing(Session("userDetails")) = False Then
					...
					PopulateApplicationStatus()
					getApplicationForDocumentation(0)
					Me.gridApplicationSummary.DataSource = cr.PMgetApplicationSummaryByStage("UnFunded")
	...
	Protected Sub getApplicationForDocumentation(typeID As Integer)
		...
		Try
			...
			dt = cr.PMgetApplicationByTpye(typeID, "UnFunded")
	...
	Protected Sub ddApplicationStatusBatch_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddApplicationStatusBatch.SelectedIndexChanged
