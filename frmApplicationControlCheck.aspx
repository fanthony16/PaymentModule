<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmApplicationControlCheck.aspx.vb" Inherits="frmApplicationControlCheck" Theme="Blue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div id="dvCriteria" style="border-color:#3a4f63; border :2px solid ;">
            ...
            <div id="dvCrBody" class="dvBoxbody">
                ...
                <div id="dvEndDate" class ="dvBoxRows">
                 ...
                 <div id="dvSPBatches" class ="dvBoxRows" >
                    <div style ="float :left; padding :0px 5px 0px 0px;">
                        
                        <asp:RadioButton ID="rdSPBatches" runat="server" GroupName="SearchType" Text ="Sent To Pencom Batches" AutoPostBack="True" />
                    </div>
                    <div style ="text-align :right ;"><asp:DropDownList ID="ddSPBatches" runat="server" Width ="297px" Enabled="False"></asp:DropDownList></div>
                </div>
                ...
                <div id="dvlodgmentID" class ="dvBoxRows" >
                    ...
                    <div style ="text-align :right ;"><asp:TextBox ID="txtPIN" Width ="185px" runat="server" Enabled="False" TextMode="MultiLine" Height="100px"></asp:TextBox></div>
                </div>
    ...
    <div class="dvMiddleBox" >
        ...
        <asp:Panel ID="pnlGrid" Width ="100%" runat ="server" BorderStyle="Solid" BorderWidth ="2px" Height ="500px" >
                                 ...
                                 <%--<asp:BoundField DataField="txtStatus" HeaderText="Status" ItemStyle-Width="100" />--%>
                                        <asp:TemplateField HeaderText="">
                                                   <ItemTemplate>
                                                                      ...
                                                                      <asp:ImageButton OnClick="btnView_Comment" ID="btnViewComments" runat ="server" ImageUrl="~/images/comment_bubble2.png" ToolTip="Add/View Comment(s)" ItemStyle-Width ="10px" />
                                  ...
                                  <asp:TemplateField HeaderText="">
                                                   <ItemTemplate>
                                                                      ...
                                                                      <asp:ImageButton OnClick="btnViewApplication_Comment" ID="btnViewApplicationComments" runat ="server" ImageUrl="~/images/comment_bubble2.png" ToolTip="View Application Comment(s)" ItemStyle-Width ="10px" />
                    ...
                    <%--<asp:BoundField DataField="txtControlCheckedStatus" HeaderText="" ItemStyle-Width="0" />--%>
                    </Columns>
        ...
        <div id="Div3" style="border-color:#3a4f63; border :2px solid ;">
            ...
            <div id="Div5" class="dvBoxbody">
               ...
               <div class="dvBoxRows" style =" width :300px;">
                    ...
                    <div style="padding-top :5px; margin-bottom  :15px;">
                    <div style ="float :left "><span>Review Status :</span></div>
                    <div style ="float :left "><asp:DropDownList ID="ddReviewStaus" runat ="server" ValidationGroup  ="AppCommentStatus" ></asp:DropDownList></div>
                    <asp:RequiredFieldValidator ID="reqddReviewStaus" runat="server" ErrorMessage="*" ControlToValidate="ddReviewStaus" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="AppCommentStatus"></asp:RequiredFieldValidator>
               ...
               <div class="dvBoxRows" style =" width :300px; padding-top :10px; ">
                     ...
                     <asp:TextBox id="txtApplicationComment" runat ="server" TextMode ="MultiLine" ValidationGroup  ="AppCommentStatus" Height="400px" Width="95%"></asp:TextBox>

                    <asp:RequiredFieldValidator ID="reqtxtApplicationComment" runat="server" ErrorMessage="*" ControlToValidate="txtApplicationComment" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="AppCommentStatus"></asp:RequiredFieldValidator>
                </div>

               <div id="dvScheduleButton"  class="dvBoxRows" style =" width :300px; float :left ; padding :10px;">
                   <div style ="width :150px; float :left ; text-align :right  ;"><asp:ImageButton ID="btnAppCommentAdd" runat ="server" ImageUrl="~/images/add.png" ToolTip="Add To Comment" CausesValidation="true" ValidationGroup  ="AppCommentStatus"  /></div>
