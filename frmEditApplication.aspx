<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmEditApplication.aspx.vb" Inherits="frmEditApplication" Theme ="Blue"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class ="bodyMainDiv" >
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span id="spCaption" runat ="server" >Benefit Payment Application</span></h2></div>
                            ...
                            <asp:Panel ID="UserReg" runat="server">
                                <div id="dvPersonalDetails" style="width :100%">
                                     <div id="dvPersonalfor" style="float :left ; width :70%; ">
                                          <div id="dvPIN" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtPIN" Width ="300px" runat="server" Enabled="false" ValidationGroup="FindPersonDetails"></asp:TextBox>
                                                    ...
                                                    <asp:Button ID="btnFind" runat="server" Text="..." Visible ="false" ValidationGroup="FindPersonDetails" />
                                               </div>
                                          </div>
                                          ...
                                          <div id="dvFirstName" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtFirstName" Width ="300px" runat="server" Enabled="false"   ></asp:TextBox>
                                          ...
                                          <div id="dvOthernames" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOtherNames" Width ="300px" runat="server" Enabled="false"   ></asp:TextBox>
                                          ...
                                          <div id="dvDOB" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtDOB" Width ="300px" runat="server" Enabled="false"   ></asp:TextBox>
                                          ...
                                          <div id="dvAge" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtAge" Width ="300px" runat="server" Enabled="false"   ></asp:TextBox>
                                          ...
                                          <div id="dvEmployer" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtEmployer" Height ="60px" Width ="300px" runat="server" Enabled="false" ReadOnly ="true" TextMode ="MultiLine"   ></asp:TextBox>
                                                    <asp:Button ID="btnEmployerHistory" runat="server" Text="View Employer History" OnClick="btnViewEmployerHistory_Click" ValidationGroup ="viewHistory" />
                                          ...
                                          <div id="dvNextofKIN" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Nexk of KIN :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtNOK" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqNOK" runat ="server" ErrorMessage="*" ControlToValidate="txtNOK" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          ...
                                          <div id="dvNextofKINTelephone" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">NOK Tel No:</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtNOKNo" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                               </div>
                                          </div>
                                     ...
                                     <div id="dvPersonalPassport" style="float :left ; width :30%;  ">
                                          ...
                                          <div style="text-align :center;"><asp:Image ID="imgSignature" runat="server" ImageUrl="~/Images/signature.jpg" /></div>
                            ...
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <div id="dvEmailAddress" class ="dvBoxRows">
                                     ...
                                     <div style ="text-align :left ;">
                                          ...
                                          <asp:ImageButton ID="imgUpdateEmail" runat="server" ImageUrl="~/images/update.bmp" ToolTip="Update Email Address" />
                                ...
                                <div id="dvTelephone" class ="dvBoxRows">
                                     ...
                                     <div style ="text-align :left ;">
                                          ...
                                          <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat ="server" ErrorMessage="*" controlToValidate="txtEmail" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>--%>
                                     </div>
                                </div>                            

                                <div id="dvAddress1" style="float :left ; width :32%; height :260px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;  background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          <span style="color:white;">Office Address</span>

                                          <div id="dvOfficeAddress" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Address :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOfficeAddress" Width ="300px" runat="server" TextMode="MultiLine" Enabled="false" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqOfficeAddress" runat ="server" ErrorMessage="*" controlToValidate="txtOfficeAddress" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>

                                          
                                          <div id="dvOfficeLGA" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">LGA :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOfficeLGA" Width ="300px" runat="server" Enabled="false"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqLGA" runat ="server" ErrorMessage="*" controlToValidate="txtOfficeLGA" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          

                                          <div id="dvOfficeState" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">State :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOfficeState" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqOfficeState" runat ="server" ErrorMessage="*" controlToValidate="txtOfficeState" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>

                                          <div id="dvUpdateOfficeAddress" class ="dvBoxRows" style="margin-top : 15px; text-align :right ;">

                                               <asp:ImageButton ID="imgUpdateOfficeState" runat="server" ImageUrl="~/images/update.bmp" ToolTip="Update Office Address" />
                                ...
                                <div id="dvAddress2" style="float :left ; width :33%; height :260px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px; background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvResidentialAddress" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtResidentialAddress" Width ="300px" runat="server" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqResidentialAddress" runat ="server" ErrorMessage="*" controlToValidate="txtResidentialAddress" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          <div id="dvResidentialLGA" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">LGA :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtResidentialLGA" Width ="300px" runat="server" Enabled="false"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqResidentialLGA" runat ="server" ErrorMessage="*" controlToValidate="txtResidentialLGA" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          <div id="dvResidentialState" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">State :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtResidentialState" Width ="300px" runat="server" Enabled="false"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqResidentialState" runat ="server" ErrorMessage="*" controlToValidate="txtResidentialState" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>

                                          <div id="dvUpdateResidentialAddress" class ="dvBoxRows" style="margin-top : 15px; text-align :right ;">

                                               <asp:ImageButton ID="imgUpdateResid" runat="server" ImageUrl="~/images/update.bmp" ToolTip="Update Residential Address"/>

                                          </div>

                                     </div>
                                </div> 
                                <div id="dvAddress3" style="float :left ; width :32%; height :260px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          <span style=" color:white;">Permanent Home Address</span>
                                          <div id="dvPermanentAddress" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Address :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtPermanentAddress" Width ="300px" runat="server" TextMode="MultiLine" Enabled="false"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqPermanentAddress" runat ="server" ErrorMessage="*" controlToValidate="txtPermanentAddress" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>

                                          <div id="dvPermanentLGA" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">LGA :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtPermanentLGA" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqPermanentLGA" runat ="server" ErrorMessage="*" controlToValidate="txtPermanentLGA" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>

                                          <div id="dvPermanentState" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">State :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtPermanentState" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqPermanentState" runat ="server" ErrorMessage="*" controlToValidate="txtPermanentState" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          
                                          <div id="dvUpdatePermanentAddress" class ="dvBoxRows" style="margin-top : 15px; text-align :right ;">

                                               <asp:ImageButton ID="imgUpdatePermanentAddress" runat="server" ImageUrl="~/images/update.bmp" ToolTip="Update Permanent Address" />
                        ...
                        <Content>
                            <asp:Panel ID="Panel3" runat="server">
                                ...
                                <div id="Div8" style="float :left ; width :25%; height :380px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 35px; background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                ...
                                <div id="Div4" style="float :left ; width :73%; height :380px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div id="Div12" style="float :left ; width :48%; height :370px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                ...
                                <div id="dvApplicationLocation" style="float :left ; width :28%;height :380px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;  background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvApplicationDate " class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtApplicationDate" runat="server" Width="245px"></asp:TextBox>
                                               </div>
                                          ...
                                          <div id="dvAddRMASDetails" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">:</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:Button ID="btnOtherDetails" runat="server" Text="Add Other Application Details" ValidationGroup="SubmittingApplicatiom"  />
                                               </div>
                                          </div>
                                     ...
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px; background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvSelectDoc" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    ...
                                                    <asp:DropDownList ID="ddRequiredDocuments" runat="server" Width="250px" ValidationGroup ="addDocument" AutoPostBack="True"></asp:DropDownList>
                                                    
                                               </div>
                                          </div>


                                          <div id="dvARL" class ="dvBoxRows" style="margin-top : 15px;" runat="server" visible ="false" >
                                               <div class="dvBoxRowsFieldLabel">
                                                    <asp:RadioButton ID="rdARLRecieved" Text ="ARL Recieved" runat="server" GroupName ="ARL" />
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:RadioButton ID="rdARLAckRecieved" Text ="ARL Request Acknowledgment" runat="server" GroupName ="ARL" />
                                               </div>

                                          </div>

                                          <div id="dvRecievedDate" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Recieved Date :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtRecievedDate" Width ="250px" runat="server" ValidationGroup ="addDocument"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqRecievedDate" runat ="server" ErrorMessage="*" controlToValidate="txtRecievedDate" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup ="addDocument" ></asp:RequiredFieldValidator>
                                          ...
                                          <div id="dvUploadDocument" class ="dvBoxRows" style ="margin-top : 1px;">
                                               ...
                                               <div id="dvUploadLabel" class="dvBoxRowsFieldLabel" runat ="server">
                                                    <span  id="spUploadText" style ="font-size : medium;">Upload Document :</span>
                                               </div>
                                          ...
                                          <div id="dvBtnRecievedDoc" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel" style="width :48%">
                                                    <%--<asp:Button ID="btnAddRecievedDoc" runat="server" Text="Remove Recieved Doc." />--%>
                                               </div>
                                               <div style ="text-align :right ; padding-right :25px;">
                                                    <asp:Button ID="btnRemoveRecievedDoc" runat="server" Text="Add to Recieved Document" ValidationGroup ="addDocument" />
                                               </div>
                                          </div>

                                          <div id="dvCommentGroup" class ="dvBoxRows" runat ="server" visible ="false" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                     ...
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvGridRecievedDocument" class ="dvBoxRows" style="margin-top : 15px; margin-left :7px;">
                                                         ...
                                                         <Columns>
                                                              ...
                                                              <asp:TemplateField HeaderText="">
                                                                  <ItemTemplate>
                                                                      ...
                                                                      <asp:ImageButton OnClick="BtnViewDocuments_Click" ID="btnViewDocument" runat ="server" ImageUrl="~/images/K view.png" ToolTip="View Document" ItemStyle-Width ="10px" />
                                               ...
                                               <div style ="text-align :right ; padding-right :8px;">
                                                    <asp:Button ID="btnRemoveDocument" runat="server" Text="Delete From Recived Document" OnClick="BtnNewDetails_Click" ValidationGroup="RemoveDocument" />
                                               </div>
                                              </div>
                                          </div>
                    ...
                    <asp:AccordionPane ID="BankDetails"  runat="server">
                        ...
                        <Content>
                            <asp:Panel ID="Panel4" runat="server">
                                ...
                                <div id="dvBankDetails" style="float :left ; width :33%; height :470px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;  background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                         ...
                                         <%-- <div id ="dvBankConfirmationUpload" style ="text-align :left ;">
                                                    <asp:AjaxFileUpload ID="FlUploadBankConfirmation" runat="server" OnUploadComplete="AjaxFileUploadEvent"  ValidationGroup ="valSchedule" />
                                          </div>--%>
                                ...
                                <div id="dvOtherComments" style="float :left ; width :33%; height :350px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;  background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <%--<div id="dvCommentGroups" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Comment Groups :</span>
                                               </div>
                                               <div style ="text-align :left ;">

                                                    <asp:DropDownList ID="ddCommentGroup" runat="server" Width="300px"></asp:DropDownList>
                                          ...
                                          <div id="dvApplicationStatus" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    ...
                                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat ="server" ErrorMessage="*" controlToValidate="txtResidentialAddress" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>--%>
                                               </div>
                                          </div>
                                         ...
                                         <div>
                                             ...
                                             <asp:ImageButton ID="imgBack" runat="server" ImageUrl="~/images/redbackbutton.png" ToolTip ="Back" Visible ="false"  />
     ...
     <asp:Panel ID="pnlRMASHardShip" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="300px">
          ...
          <div id="Div15" class ="SubbodyMainDiv" style="height:200px;">
               ...
               <%--<div id="Div1" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtRetirementDate" runat="server" Width="295px"></asp:TextBox>
                                               </div>
                                               <asp:RequiredFieldValidator ID="reqRetirementDate" runat ="server" ErrorMessage="*" controlToValidate="txtRetirementDate" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="HardShipDetails" ></asp:RequiredFieldValidator>
    ...
    <div id="dvleftBox" class ="bodyMainDiv" style ="width:900px;"> 
               ...
               <div class="dvBoxRows" >
                       ...
                       <asp:GridView Width="800px" ID="gridCustomerHistory" runat="server" Visible="true" PageSize="10" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridCustomerHistory_RowDataBound">                       
                           ...
                           <Columns>                                           
                                ...
                                <asp:BoundField DataField="EmployerCode" HeaderText="Employer Code" ItemStyle-Wrap ="false" ItemStyle-Width="150"/>
     ...
     <asp:Panel ID="pnlLegacy" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="300px">
          ...
          <div id="Div16" class ="SubbodyMainDiv" style="height:200px;">
               ...
               <div id="Div23" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel" style="width:200px;">
                                                    <span style ="font-size : medium;">Retirement Date :</span>
                                               </div>
                                               <div style ="text-align :left ; padding-left : 250px;">
    ...
    <asp:Button ID="btnMPRMASLegacy" runat="server" Text="Cancel" />
     ...
     <asp:Panel ID="pnlRMASPW" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="1050px">
          ...
          <div id="Div24" class ="SubbodyMainDiv" style="height:1150px;">

               <div id="dvBasicSalaryPW" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvHouseRent" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvTransport" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvUtility" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvConsolidatedAllowance" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvConsolidatedSalaryPW" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvMonthlyTotalPW" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvAnnualTotalEmolument" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvValueDate" class ="dvBoxRows" style="margin-top : 5px;">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:CompareValidator ID="compValueDate" runat="server" ErrorMessage="Bad Input" ControlToValidate="txtValueDate" Display="Dynamic" Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
               ...
               <div id="dvAcruedRight" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
                         <span style ="font-size : medium;">Accrued Right :</span>
                    </div>
                    <div style ="text-align :left ; padding-left : 250px;">
               ...
               <div id="dvRSABalancPWe" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
               ...
               <div id="dvRecommendedLumpSum" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
               ...
               <div id="dvMonthlyDrawDown" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
    ...
    <asp:Button ID="btnMPRMASPW" runat="server" Text="Cancel" />
     ...
     <asp:Panel ID="pnlRMASAnnuity" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="1040px">
          ...
          <div class ="bodyMainDiv" style="height:1250px; width: 100%" >
          <div id="Div25" style ="padding-left :20px;"><h2><span>Annuity RMAS Details</span></h2></div>
          
          <div id="Div26" class ="SubbodyMainDiv" style="height:1150px;">

               <div id="dvBasicSalaryAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvHouseRentAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvTransportAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvUtilityAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvConsolidatedAllowanceAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvConsolidatedSalaryAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvMonthTotalAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvAnnualTotalEmolumentAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
               ...
               <div id="dvValueDateAnnuity" class ="dvBoxRows" style="margin-top : 5px;">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
                         <span style ="font-size : medium;">Value Date :</span>
                    </div>
               ...
               <div id="dvCommencmentDate" class ="dvBoxRows" style="margin-top : 5px;">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
               ...
               <div id="dvInsuranceCoy" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:RequiredFieldValidator ID="reqInsuranceCoy" runat ="server" ErrorMessage="*" controlToValidate="txtInsuranceCoy" Display="Dynamic" SetFocusOnError="True" ValidationGroup="AnnuityDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>

                    </div>
               </div>

               <div id="dvRSABalanceAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
                         <span style ="font-size : medium;">RSA Balance :</span>
                    </div>
                    <div style ="text-align :left ; padding-left : 250px;">
               ...
               <div id="dvPremiumAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
               ...
               <div id="dvlumpsum" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
               ...
               <div id="dvMonthlyAnnuity" class ="dvBoxRows" style="margin-top : 5px; ">
                    <div class="dvBoxRowsFieldLabel" style="width:200px;">
    ...
    <asp:Button ID="btnMPRMASAnnuity" runat="server" Text="Cancel" />
     ...
     <asp:Panel ID="pnlRMASDeathBenefit" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="600px">
          ...
          <div id="Div31" style ="padding-left :20px;"><h2><span>Death Benefit RMAS Details</span></h2></div>
          ...
          <div id="Div32" class ="SubbodyMainDiv" style="height:540px;">       
               ...
               <div id="dvDBARetirementDate" class ="dvBoxRows" style="margin-top : 2px;">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:CompareValidator ID="compDBARetirementDate" runat="server" ErrorMessage="Bad Input" ControlToValidate="txtDBARetirementDate" Display="Dynamic" Operator="DataTypeCheck" Type="Date" ValidationGroup="DBADetails"></asp:CompareValidator>
               ...
               <div id="dvDeathDate" class ="dvBoxRows" style="margin-top : 2px;">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:CompareValidator ID="compDBADeathDate" runat="server" ErrorMessage="Bad Input" ControlToValidate="txtDBADeathDate" Display="Dynamic" Operator="DataTypeCheck" Type="Date" ValidationGroup="DBADetails"></asp:CompareValidator>
               ...
               <div id="dvAdminLetterDate" class ="dvBoxRows" style="margin-top : 2px;">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:CompareValidator ID="compAdminLetterDate" runat="server" ErrorMessage="Bad Input" ControlToValidate="txtAdminLetterDate" Display="Dynamic" Operator="DataTypeCheck" Type="Date" ValidationGroup="DBADetails"></asp:CompareValidator>
               ...
               <div id="dvDBAInsuranceProceed" class ="dvBoxRows" style="margin-top : 2px; ">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:CompareValidator ID="comInsuranceProceed" runat="server" ErrorMessage="Bad Input" ControlToValidate="txtInsuranceProceed" Display="Dynamic" Operator="DataTypeCheck" Type="Double" ValidationGroup="DBADetails"></asp:CompareValidator>
               ...
               <div id="dvDBAAccruedRight" class ="dvBoxRows" style="margin-top : 2px; ">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         ...
                         <asp:CompareValidator ID="compDBAAccruedRight" runat="server" ErrorMessage="Bad Input" ControlToValidate="txtDBAAccruedRight" Display="Dynamic" Operator="DataTypeCheck" Type="Double" ValidationGroup="DBADetails"></asp:CompareValidator>
