<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmRMU.aspx.vb" Inherits="frmRMU" Theme ="Blue"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="updcontent" runat ="server" >
      ...
      <div style=" width :100%; padding : 0px; border-color:#3a4f63; border :2px solid ; margin-bottom :20px; border-radius :25px 25px 0px 0px;">
                        <div id="Div10" style ="text-align:center ; background-color:#3a4f63; font-size :14px; height :25px; border-radius :25px 25px 0px 0px;">
                             <span style ="color :#dde4ec;"><strong>Select Criteria</strong></span> 
                        </div>
                ...
                <div id="dvEndDate" class ="dvBoxRows">
                        ...
                        <asp:Panel ID="pnlEndDate" runat="server">
                          ...
                          <div id="Div11" class ="dvBoxRows">
                                <div style ="float :left; width:80px"><span>Title :</span></div>
                                <div style="text-align :right ; "><asp:DropDownList ID="ddTitle" runat="server" Width ="200px" ValidationGroup="FindType"></asp:DropDownList>
                          ...
                          <div id="dvAge" class ="dvBoxRows">
                                <div style ="float :left; width:80px"><span>Age:</span></div>
                                <div style="text-align :right ; "><asp:DropDownList ID="ddAge" runat="server" Width ="200px" ValidationGroup="SI"></asp:DropDownList>
                          ...
                          <div id="dvServiceYear" class ="dvBoxRows">
                                <div style ="float :left; width:80px"><span>Years:</span></div>
                                <div style="text-align :right ; "><asp:DropDownList ID="ddYearsOfService" runat="server" Width ="200px" ValidationGroup="SI"></asp:DropDownList>
                          ...
                          <div id="dvSector" class ="dvBoxRows">
                                <div style ="float :left; width:100px"><span>Sector:</span></div>
                                <div style="text-align :right ; "><asp:DropDownList ID="ddSector" runat="server" Width ="200px" ValidationGroup="SI"></asp:DropDownList>
                                     <%--<asp:RequiredFieldValidator ID="reqddAnnYear" runat="server" ErrorMessage="*" ControlToValidate="ddAnnYear" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="SI"></asp:RequiredFieldValidator>--%>
                         </div>
</div> 


             <div id="dvDate" class ="dvBoxRows">
                                <div style ="float :left; width:100px"><span>Date:</span></div>
                                <div style="text-align :right ; "><asp:TextBox ID="txtDate" runat="server" Width ="194px"></asp:TextBox>
                                     <asp:RequiredFieldValidator ID="reqDate" runat="server" ControlToValidate="txtDate" Display="Dynamic" ErrorMessage="*" Font-Bold="True" ForeColor="Red"></asp:RequiredFieldValidator>
                         </div>

                  <asp:PopupControlExtender ID="calSDate_PopupControlExtender" runat="server" Enabled="True" ExtenderControlID="" PopupControlID="pnlDate" Position="Bottom" TargetControlID="txtDate"></asp:PopupControlExtender>
                <asp:Panel ID="pnlDate" runat="server">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                       ...
                       <%--   <div id="dvAppStatus" class ="dvBoxRows">
                        ...
                        <div style ="text-align :right ; padding :5px;"><asp:Button ID="btnGenerate" runat="server" Text="Generate" /></div>
            <asp:Panel ID="Panel1" runat ="server" Visible="False"><div style ="padding:5PX;"><span id="Span1" runat ="server" >.</span></div></asp:Panel>
                ...
                <div id="dvValidatdEmail" style =" border :2px solid ;">
                    <asp:Panel ID="pnlSoonToRetiree" Width ="100%" runat ="server" BorderStyle="Solid" BorderWidth ="2px" Height ="500px" >
                    <asp:GridView Width="100%" ID="gridSoonToRetiree" runat="server" Visible="true" PageSize="50" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridSoonToRetiree_RowDataBound">
                    <Columns>
                       ...
                       <%-- <asp:BoundField DataField="pkiSIApproval" HeaderText="Standing Order ID" ItemStyle-Wrap ="false" ItemStyle-Width="100"/>                --%>       
                        <asp:BoundField DataField="rsapin" HeaderText="PIN" ItemStyle-Wrap ="false" ItemStyle-Width="100"/>
                        <asp:BoundField DataField="title" HeaderText="Title" Visible ="true" ItemStyle-Width="50"/>
                        <asp:BoundField DataField="Name" HeaderText="Full Name" ItemStyle-Width="150"/>
                        <%--<asp:BoundField DataField="Name" HeaderText="Full Name" DataFormatString="{0:N}" ItemStyle-Width="100"/>--%>
                        <asp:BoundField DataField="dateofbirth" HeaderText="Date Of Birth" DataFormatString="{0:d}" Visible ="true" ItemStyle-Width="50"/>
                        <%--<asp:BoundField DataField="age" HeaderText="Age" Visible ="true" ItemStyle-Width="30"/>--%>
                        <asp:BoundField DataField="EmployerName" HeaderText="Employer Name" Visible ="true" ItemStyle-Width="250"/>
                        <asp:BoundField DataField="firstemploymentdate" HeaderText="First Employment Date" DataFormatString="{0:d}" Visible ="true" ItemStyle-Width="50"/>
                        <%--<asp:BoundField DataField="YearOfService" HeaderText="Year Of Service"  Visible ="true" ItemStyle-Width="50"/>--%>
                         ...
                         <%--<asp:TemplateField HeaderText="">
                          ...
                          <%--<asp:TemplateField HeaderText="">
                                                                  <ItemTemplate>
                                                                      ...
                                                                      <asp:ImageButton OnClick="BtnViewSI_Click" ID="btnViewSI" runat ="server" ImageUrl="~/images/remove.png" ToolTip="View Standing Instruction" OnClientClick="BtnViewSI_Click" ItemStyle-Width ="10px" />
            ...
            position="Bottom"/> 
                ...
                <div style =" border :2px solid; height :20px; padding :20px;">
                     <div style="float:left ;padding-left :0px; "><asp:ImageButton ID="imgExportExcel" runat ="server" ImageUrl="~/images/xls.png" ToolTip="Download Schedule Soft Copy" Visible="true"/>
    ...
    <asp:Button ID="btnMPAppComments" runat="server" Text="Close" />
                 ...
                 <asp:Button id="btnShowEligibityPopup" runat="server" style="display:none" />
   <asp:ModalPopupExtender ID="mpEligibityPopup" runat="server" PopupControlID="pnlEligibityPopup" TargetControlID="btnShowEligibityPopup" CancelControlID="btnShowEligibityCancelPopup" BackgroundCssClass="modalBackground" ></asp:ModalPopupExtender>                
   <asp:Panel ID="pnlEligibityPopup" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="150px">

    <div id="Div17" class ="dvSideBox"> 
        
        <div id="Div18" style="border-color:#3a4f63; border :2px solid ;">

            <div id="Div19" class ="dvBoxHeader"><span style ="color :#dde4ec;"><strong>Eligibity Alert</strong></span></div>
            <div id="Div20" class="dvBoxbody">
               ...
               <div class="dvBoxRows" style =" width :300px;">
                    ...
                    <div style ="float :left "><span>Please, you may download the List of already Accessed HardShip Payment and Age is 50 years and above<span></div>
               ...
               <div class="dvBoxRows" style =" width :300px; padding-top :10px; ">
                     ...
                     <asp:Button ID="btnDownLoadList" Text ="Export List" runat="server" ValidationGroup="AVCDetails" />
    ...
    <asp:Button ID="btnShowEligibityCancelPopup" runat="server" Text="Close" />
    </asp:Panel>
