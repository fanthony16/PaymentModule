<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmStandingIRun.aspx.vb" Inherits="frmStandingIRun" theme="Blue"%>
    ...
    <asp:UpdatePanel ID="updcontent" runat ="server" >
      ...
      <div style=" width :100%; padding : 0px; border-color:#3a4f63; border :2px solid ; margin-bottom :20px; border-radius :25px 25px 0px 0px;">
              ...
              <div id="Div13" class ="dvBoxRows">
                                <div style ="float :right; width:100%"><asp:CheckBox ID="chkViewApproved" runat ="server" Text ="View Approved" AutoPostBack="True" /></div>
                                <div style="text-align :right ; "><asp:Button ID ="btnViewButton" runat ="server" Text ="View Approved" Visible="False" />
            ...
            position="Bottom"/> 
                ...
                <div style =" border :2px solid; height :20px; padding :20px;">
                     ...
                     <div id="Div3" style="float:left; padding-left :20px;" runat ="server" visible="true" ><asp:Button ID="btnVet" runat="server" Text="Vet" /></div>

                      <div id="dvExportButton" style="float:left; padding-left :20px;" runat ="server" visible="false" ><asp:Button ID="btnExportSIs" runat="server" Text="Export Approved Standing Orders" Font-Bold="True" /></div>

                     <div id="dvExportMessage" style="float:left; padding-left :20px;" runat ="server" visible="false" ><span id ="spExportMessage" style ="color :red " > NOTE THAT FILES WILL BE EXPORTED TO THE FOLLOWING LOCATION. (C:\SI\)</span></div>
