...
Partial Class frmforSubmission
     ...
     Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
          Try
               Dim dtusers As New DataTable, scriptManagerA As New ScriptManager, scriptManagerb As New ScriptManager
			...
			scriptManagerb = ScriptManager.GetCurrent(Me.Page)
			scriptManagerb.RegisterPostBackControl(Me.btnHardShipProcessingBatch)
	...
	End Sub
     ...
     Protected Sub btnHardShipProcessingBatch_Click(sender As Object, e As EventArgs) Handles btnHardShipProcessingBatch.Click
		...
		Dim cb As CheckBox, chk As Integer = 0, cr As New Core, brokers As New List(Of String), dt As New DataTable, lstSchedules As New List(Of RMASSchedule), apptype As String = "", appTypeID As Integer
     ...
     Protected Sub btnNonSubmissionSchedule_Click(sender As Object, e As EventArgs) Handles btnNonSubmissionSchedule.Click
          ...
          Dim cb As CheckBox, chk As Integer = 0, cr As New Core, brokers As New List(Of String), dt As New DataTable, lstSchedules As New List(Of RMASSchedule), apptype As String = ""
          ...
          Try
			...
			Do While i < lstSchedules.Count
				...
				If lstSchedules(i).Gender = 1 Then
