...
Partial Class frmApprovalControlCheck
     ...
     Protected Sub gridExport_OnRowDataBound(sender As Object, e As GridViewRowEventArgs)
          ...
          If IsNothing(ViewState("BatchApprovals")) = False Then
               ...
               If e.Row.RowType = DataControlRowType.DataRow Then
				...
				''MsgBox("" & dt.Rows(e.Row.RowIndex).Item("IsAppControlChecked").ToString)
				'If CBool(dt.Rows(e.Row.RowIndex).Item("IsAppControlChecked")) = True Then
	...
	End Sub
               ...
               Else
                    ...
                    For Each grow As GridViewRow In Me.gridApplications.Rows
                         ...
                         If cb.Checked = True And cb.Enabled = True Then
                              PMUpdateApprovalControlCheck(grow.Cells(4).Text, Session("user"), "CHECKED")
                         Else
                         End If
     ...
     Protected Sub btnCancelChecked_Click(sender As Object, e As EventArgs) Handles btnCancelChecked.Click
          Try


			Dim indx As Integer = Me.gridApplications.SelectedIndex, dt As New DataTable, cr As New Core

			'MsgBox("" & CStr(ViewState("AppCode")))
			...
			Else
				...
				cr.PMCancelPaymentControls(CStr(ViewState("AppCode")), Session("user"), "Checked")
	...
	Protected Sub BtnViewDetails_Click(sender As Object, e As EventArgs)
		...
		ApprovalTypeCollection = ViewState("ApprovalTypeCollection")
		typeID = (CInt(ApprovalTypeCollection.Item(Me.gridApplications.Rows(i.RowIndex).Cells(4).Text)))

		Response.Redirect(String.Format("frmEditApplication.aspx?ApplicationCode={0}&ApplicationTypeID={1}&ReadOnly={2}&ReturnPage={3}", Server.UrlEncode(appCode), Server.UrlEncode(typeID), 0, Server.UrlEncode("frmApprovalControlCheck")))
