<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmApplication.aspx.vb" Inherits="frmApplication" Theme ="Blue" %>
                                     ...
                                     <div id="dvPersonalfor" style="float :left ; width :70%; ">
                                          ...
                                          <div id="dvNextofKINTelephone" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    ...
                                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat ="server" ErrorMessage="*" ControlToValidate="txtNOK" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>--%>
                                               </div>
                                          </div>
                                ...
                                <div id="dvAddress1" style="float :left ; width :32%; height :260px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;  background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvOfficeAddress" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOfficeAddress" Width ="300px" runat="server" TextMode="MultiLine" Enabled="true" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqOfficeAddress" runat ="server" ErrorMessage="OA" controlToValidate="txtOfficeAddress" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          ...
                                          <div id="dvOfficeLGA" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOfficeLGA" Width ="300px" runat="server" Enabled="true"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqLGA" runat ="server" ErrorMessage="OL" controlToValidate="txtOfficeLGA" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>
                                          ...
                                          <div id="dvOfficeState" class ="dvBoxRows" style="margin-top : 15px;">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtOfficeState" Width ="300px" runat="server" Enabled="true" ></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqOfficeState" runat ="server" ErrorMessage="OS" controlToValidate="txtOfficeState" Display="Dynamic" SetFocusOnError="True" ValidationGroup="personDetails" Font-Bold="True" ForeColor="Red" ></asp:RequiredFieldValidator>
                                               </div>
                                          </div>

                                          <div id="dvUpdateOfficeAddress" class ="dvBoxRows" style="margin-top : 15px; text-align :right ;">

                                               <asp:ImageButton ID="imgUpdateOffice" runat="server" ImageUrl="~/images/update.bmp" ToolTip="Update Office Address" ValidationGroup ="UpdateOfficeAddress"  />
                                ...
                                <div id="dvAddress2" style="float :left ; width :33%; height :260px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px; background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvUpdateResidentialAddress" class ="dvBoxRows" style="margin-top : 15px; text-align :right ;">
                                               ...
                                               <asp:ImageButton ID="imgUpdateResid" runat="server" ImageUrl="~/images/update.bmp" ToolTip="Update Residential Address" ValidationGroup ="UpdateResidentialAddress"/>
                                ...
                                <div id="Div4" style="float :left ; width :73%; height :380px; border-style: solid; border-width: thin; border-radius: 25px; margin : 5px;">
                                     ...
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px;background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id="dvRFBalance" class ="dvBoxRows" style="margin-top : 15px;">
                                               <div class="dvBoxRowsFieldLabel">
                                                    <span style ="font-size : medium;">Fund IV Balance :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                     ...
                                     <div style="width :100%; border-radius :25px 25px 0px 0px; border-style: solid; border-width: thin;height : 30px; background-color :#465c71; text-align:center; padding-top : 3px; font-size: 16px;">
                                          ...
                                          <div id ="dvUploadOtherDocuments" runat ="server" visible ="false">
                                               ...
                                               <div style ="text-align :left ;">
                                                    ...
                                                    <asp:TextBox ID="txtAdhocDocDescription" runat ="server" Width="250px" ></asp:TextBox>
     ...
     <asp:Panel ID="pnlRMASPW" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="740px">
          ...
          <div id="Div24" class ="SubbodyMainDiv" style="height:690px;">
               ...
               <div id="dvValueDate" class ="dvBoxRows" style="margin-top : 2px;">
                    ...
                    <div style ="text-align :left ; padding-left : 250px;">
                         <asp:TextBox ID="txtValueDate" runat="server" Width="300px" Text ="0.00" ValidationGroup="PWDetails"></asp:TextBox>
