<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmSIApproval1.aspx.vb" Inherits="frmSIApproval1" Theme ="Blue"  %>
      ...
      <div style=" width :100%; padding : 0px; border-color:#3a4f63; border :2px solid ; margin-bottom :20px; border-radius :25px 25px 0px 0px;">
            ...
            position="Bottom"/> 
                ...
                <div style =" border :2px solid; height :20px; padding :20px;">
                     ...
                     <div id="Div3" style="float:left; padding-left :20px;" runat ="server" visible="true" ><asp:Button ID="btnApprove" runat="server" Text="Approve" /></div>
