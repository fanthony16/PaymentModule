<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmStandingPensionerConfirm.aspx.vb" Inherits="frmStandingPensionerConfirm" Theme ="Blue" %>
        ...
        <ContentTemplate>
            ...
            <div id="dvCriteria" style="border-color:#3a4f63; border :2px solid ;">
                ...
                <asp:Panel ID="pnlEndDate" runat="server">
                    ...
                    <div style="padding:0px; float :left ; width :300px;">
                          ...
                          <div style ="text-align:right;"><asp:Button ID="btnViewRecords" runat="server" Text="View Records" /></div>
                ...
                <div id="dvValidatdEmail" style =" border :2px solid ;">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="txtRequestType" HeaderText="Request Type" Visible ="true" ItemStyle-Width="50"/>
            ...
            position="Bottom"/> 
                ...
                <div style =" border :2px solid; height :20px; padding :20px;">
                     ...
                     <div id="Div3" style="float:left; padding-left :20px;" runat ="server" visible="true" ><asp:Button ID="btnConfirmSI" runat="server" Text="Confirm" /></div>
