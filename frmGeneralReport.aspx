<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmGeneralReport.aspx.vb" Inherits="frmGeneralReport" Theme="Blue" %>
          ...
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ;">
               ...
               <div id="dvSideBox" style="float:left; width:320px; height :300px;  padding :8px;" >
                ...
                <div id="dvStateDate" class ="dvBoxRows">
                                ...
                                <div style="text-align :right ;"><asp:TextBox ID="txtStartDate" runat="server" Width ="200px" ValidationGroup="FindByType"></asp:TextBox>

                                     <asp:RequiredFieldValidator ID="reqStateDate" runat="server" ErrorMessage="*" ControlToValidate="txtStartDate" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="ViewReport"></asp:RequiredFieldValidator>
                ...
                <div id="dvEndDate" class ="dvBoxRows">
                                ...
                                <div style="text-align :right ; "><asp:TextBox ID="txtEndDate" runat="server" Width ="200px" ValidationGroup="FindByType"></asp:TextBox><asp:RequiredFieldValidator ID="reqEndDate" runat="server" ErrorMessage="*" ControlToValidate="txtEndDate" Display="Dynamic" SetFocusOnError="True" Font-Bold="True" ForeColor="Red" ValidationGroup="ViewReport"></asp:RequiredFieldValidator>            
                                </div>
                        ...
                        <asp:Panel ID="pnlEndDate" runat="server">
                          ...
                          <div id="Div9" class ="dvBoxRows">
                                ...
                                <div style="text-align :right ; "><asp:DropDownList ID="ddApplicationType" runat="server" Width ="200px" ValidationGroup="FindByType"></asp:DropDownList>
                                 ...
                                 <div id="dvReportType" class ="dvBoxRows">
                                <div style ="float :left; width:80px"><span>Report Type</span></div>
                                <div style="text-align :right ; "><asp:DropDownList ID="ddReportType" runat="server" Width ="200px" ValidationGroup="FindByType" AutoPostBack="True"></asp:DropDownList>

                         </div>
</div> 


                        <div style ="text-align :right ; padding :5px;"><asp:Button ID="btnFindByDate" runat="server" Text="Find" ValidationGroup="ViewReport"  /></div>
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; width :1000px; " >
                    <asp:Panel ID="pnlGridApplication" Width ="100%" runat ="server" Height ="600px"  >
                         ...
                         <div id="dvApplicationDetails" style ="text-align:center ; background-color:#3a4f63; font-size :14px; height :25px; border-radius :25px 25px 0px 0px;">
                             <span style ="color :#dde4ec;"><strong>Benefit Application's Reports</strong></span> 
                        </div>
                            ...
                            <asp:GridView Width="100%" ID="gridParticipantApps" runat="server" Visible="true" PageSize="30" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true">
                                 <Columns>
                                        ...
                                        <asp:BoundField DataField="ApplicationType" HeaderText="APPLICATION TYPE" ItemStyle-Width="150" DataFormatString="{0:d}" />
                                        <asp:BoundField DataField="txtPIN" HeaderText="PIN" ItemStyle-Width="250" />
                                        <asp:BoundField DataField="FullName" HeaderText="CUSTOMERS NAMES" ItemStyle-Width="250" />
                                        <asp:BoundField DataField="dteApplicationDate" HeaderText="Application Date" ItemStyle-Width="250" />
