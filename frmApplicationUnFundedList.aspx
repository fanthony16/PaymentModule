<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmApplicationUnFundedList.aspx.vb" Inherits="frmApplicationUnFundedList" Theme ="Blue"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:UpdatePanel ID="updFormPanel" runat="server">
          ...
          <div id="dvMainDvTitle" style ="padding-left :20px;"><h2><span>Benefit UnFunded Application List...</span></h2></div>
            ...
            <asp:Panel ID="pnlMessage" runat ="server" Visible="False"><div style ="padding:5PX;"><span id="spnMessage" runat ="server" >.</span></div></asp:Panel>
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; " >
                    ...
                    <asp:Panel ID="pnlGrid" Width ="100%" runat ="server" Height ="500px"  >
                            <asp:GridView Width="100%" ID="gridProcessing" runat="server" Visible="true" PageSize="50" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" AllowPaging ="true" OnRowDataBound ="gridProcessing_RowDataBound">
                                 <Columns>
    ...
    <div id="Div8" class ="dvSideBox" style="width :98%"> 
        ...
        <div id="Div9" style="border-color:#3a4f63; border :2px solid ; width :100%;">
            ...
            <div id="Div10" class ="dvBoxHeader"><span style ="color :#dde4ec;"><strong>Benefit Application Summary</strong></span></div>
   ...
   <asp:Panel ID="pnlAppIACComments" runat="server" CssClass="modalPopup" align="center" style = "display:none" Height ="530px">
    ...
    <div id="Div12" class ="dvSideBox"> 
        
        <div id="Div13" style="border-color:#3a4f63; border :2px solid ;">

            <div id="Div14" class ="dvBoxHeader"><span style ="color :#dde4ec;"><strong>Internal Control Application Comment</strong></span></div>
            <div id="Div15" class="dvBoxbody">
