<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmApplicationLite.aspx.vb" Inherits="frmApplicationLite" Theme ="Blue"  %>
                            ...
                            <asp:Panel ID="UserReg" runat="server">
                                <div id="dvPersonalDetails" style="width :100%">
                                     ...
                                     <div id="dvPersonalPassport" style="float :left ; width :30%;  ">
                                          ...
                                          <div style ="float :left ;width :100%;" ><asp:CheckBox ID="chkConfirmedPassport" Text =" Is Passport Comfirmed?" TextAlign ="Right"  runat="server" /><asp:Button ID="btnShowPicture" runat="server" Text="Show Picture" /></div>
                                          <div style="text-align :center; width :90%"><asp:Image ID="imgSignature" runat="server" ImageUrl="~/Images/signature.jpg" /></div>
                                          <div style ="float :left ;width :100%;" ><asp:CheckBox ID="chkConfirmedSignature" Text =" Is Signature Comfirmed?" TextAlign ="Right"  runat="server" /><asp:Button ID="btnShowSignature" runat="server" Text="Show Picture" /></div>
                                     </div>
