<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="frmPencomTemplate2.aspx.vb" Inherits="frmPencomTemplate2" Theme ="Blue"  %>
     ...
     <div class ="bodyMainDiv" >
          ...
          <div id="dvSubbodyMainDiv" class ="SubbodyMainDiv" style="text-align:center ; float :left ;">
               ...
               <div class="dvMiddleBox" style="border-radius :25px 25px 0px 0px; border :2px solid; margin-top :10px; padding  :5px 10px 0px 10px; " >
                    ...
                    <div id="dvRetirementDate" class ="dvBoxRows">
                      ...
                      <div id="dvAge" class ="dvBoxRows">
                                               ...
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtAge" Width ="300px" runat="server" Enabled="FALSE" AutoPostBack ="true"  ></asp:TextBox>
                    ...
                    <div id="dvNc" class ="dvBoxRows">
                     ...
                     <div id="dvEnhanceAmt" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel" >
                                                    <span style ="font-size : medium;">Enhanced.Amt:</span>
                                               </div>
                                               <div style ="text-align :left ;">
                    ...
                    <div id="dvMaxEnhance" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel" >
                                                    <span style ="font-size : medium;">Max Enhance :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtMaxEnhanced" Width ="300px" runat="server" Enabled="false" Text ="0" ></asp:TextBox>
                                               </div>
                        </div>

                    <div id="dvReserve" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel" >
                                                    <span style ="font-size : medium;">Reserve :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtReserve" Width ="300px" runat="server" Enabled="false" Text ="0" ></asp:TextBox>
                                               </div>
                        </div>
                     ...
                     <div id="dvVariance" class ="dvBoxRows">
                                               <div class="dvBoxRowsFieldLabel" >
                                                    <span style ="font-size : medium;">Surplus :</span>
                                               </div>
                                               <div style ="text-align :left ;">
                                                    <asp:TextBox ID="txtSurplus" Width ="300px" runat="server" Enabled="false" ></asp:TextBox>
                                               </div>
                        </div>
